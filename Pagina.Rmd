...
#5 variables
dfTreemap <- datos 
dfTreemap <- datos %>% mutate(value = ifelse(Delito == "ASALTO", 1,
                                             ifelse(Delito == "HOMICIDIO", 1,
                                                    ifelse(Delito == "HURTO", 1,
                                                           ifelse(Delito == "ROBO", 1,
                                                                  ifelse(Delito == "ROBO DE VEHICULO", 1, 1
                                                                         )
                                                                  )
                                                           )
...
grafThree = treemap(dfTreemap,
            index=c("Delito", "SubDelito", "Provincia", "Canton", "Distrito"),
            type="index",
            vSize = "value",
            palette = "Set2",
            bg.labels=c("white"),
